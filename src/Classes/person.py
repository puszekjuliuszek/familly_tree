...
class Person:
    ...
    # TODO zmienić nazwy w jsonie + wywalić children id i partner id z jsona
    def update_from_dict(self, data: dict):
        ...
        self.children_id = data.get('children_id', self.children_id)
        self.partners_id = data.get('partners_id', self.partners_id)

    #TODO tworzenie tablicy id dla dzieci i partnerów
    def get_id_list(self):
        pass

    def print_person(self):
        print(f"Person ID: {self.person_id}")
        print(f"Father ID: {self.father.person_id}")
        print(f"Mother ID: {self.mother.person_id}")
        print(f"First name: {self.first_name}")
        print(f"Last name: {self.last_name}")
        print(f"Birth date: {self.birth_date}")
        print(f"Death date: {self.death_date}")
        print(f"Children ID: {self.children_id}")
        print(f"Partners ID: {self.partners_id}")

    #TODO wykorzystanie metody get_id_list
    def to_dict(self) -> dict:
        return {
            ...
            "partners_id": self.partners_id,
        }

    #TODO wypisywanie na konsolę drzewa
    def print_tree(self):
        pass
